    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-black mb-4">Text Detector</h1>
          <p className="text-lg text-black max-w-2xl mx-auto">
            Analyze text content to detect AI-generated patterns using advanced NLP models.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
              <h2 className="text-2xl font-bold text-black mb-6">Analyze Your Text</h2>
              <TextForm onResult={handleResult} onLoading={handleLoading} />
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
              ...
              {isLoading ? (
                ...
                <div className="text-center text-black py-12">
                  ...
                  <p className="text-sm">Enter some text and click "Analyze Text" to get started</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="mt-12 bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
            <h3 className="text-2xl font-bold text-black mb-6">How Text Detection Works</h3>
              ...
              <div>
                ...
                <ul className="space-y-2 text-black">
                  <li className="flex items-start">
                    ...
                    <span>Statistical text analysis and pattern recognition</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Language model probability distributions</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Writing style consistency analysis</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>Repetitive pattern detection</span>
                  </li>
                </ul>
              </div>
              <div>
